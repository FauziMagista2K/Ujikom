                        ...
                        <form action="#" method="post">
                            ...
                            <form>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="kd_dosen" value="<?php echo $dosenByID['kd_dosen'] ?>" placeholder="Username">
                                    </div>
                                </div>
                                <br>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nama_dosen" value="<?php echo $dosenByID['nama'] ?>" placeholder="Username">
                                    </div>
                                </div>
                                <br>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="alamat" value="<?php echo $dosenByID['alamat'] ?>" placeholder="Username">
                                        <br>
