                                ...
                                <tbody>
                                    ...
                                    while ($record = $data_matkul->fetch_array()) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary" href="edit.php?kd_matkul=<?php echo $record['kd_matkul'] ?>">Edit</a>
                                                <a class="btn btn-danger" href="hapus.php?kd_matkul=<?php echo $record['kd_matkul'] ?>">Hapus</a>
                                            </td>
                                        </tr>
                                        </tr>
                                        </tr>
