                        ...
                        <form action="#" method="post">
                            ...
                            <form>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="kd_matkul" value="<?php echo $matkulByID['kd_matkul'] ?>" placeholder="Username">
                                    </div>
                                </div>
                                <br>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nama_matkul" value="<?php echo $matkulByID['nama'] ?>" placeholder="Username">
                                    </div>
                                </div>
                                <br>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="sks" value="<?php echo $matkulByID['sks'] ?>" placeholder="Username">
                                        <br>
