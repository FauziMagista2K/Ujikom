                                    ...
                                    while ($record = $data_dosen->fetch_array()) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php echo $record['kd_dosen'] ?>"><button type="submit" class="btn btn-primary"> Edit</button>
                                                </a>
                                                <a href="hapus.php?kd_dosen=
                                                <?php echo $record['kd_dosen'] ?>"><button type="submit" class="btn btn-danger"> Hapus</button></a>
                                            </td>
                                        </tr>
                                        </tr>
                                        </tr>
