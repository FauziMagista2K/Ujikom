...
$barangByID = $data->get_barangById($id_barang)->fetch_assoc();
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <form action="#" method="post">
                            ...
                            <form>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="id_barang" value="<?php echo $barangByID['id_barang'] ?>" disabled>
                                    </div>
                                </div>
                                <br>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="namabarang" value="<?php echo $barangByID['namabarang'] ?>">
                                    </div>
                                </div>
                                <br>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="satuan" value="<?php echo $barangByID['satuan'] ?>">
                                    </div>
                                </div>
                                <br>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="hargasatuan" value="<?php echo "" . number_format($barangByID['hargasatuan']) . ""; ?>">
                                        <br>
                        ...
                        if (isset($_POST['namabarang'])) {
                            ...
                            if ($data->update_barang($id_barang, $namabarang, $satuan, $hargasatuan)) {
